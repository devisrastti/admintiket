                    ...
                    <div class="col-md-4 offset-md-4">
                        <form action="{{ url ('jadwal') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kota_asal" class="form-control" autofocus required>
                            </div>
                            <div class="form-group">
                                <label>Kota Tujuan</label>
                                <input type="text" name="kota_tujuan" class="form-control" autofocus required>
                            </div>
                            <div class="form-group">
                                <label>Hari</label>
                            ...
                            <div class="form-group">
                                <label>Harga</label>
                                <input type="integer" name="harga" class="form-control" autofocus required>
                            </div>
